import type { Vote } from '@remark42/api/dist/clients/public'
import type { Comment, Thread as OriginalThread, User, Sort } from '@remark42/api/dist/typings'
import { get, writable } from 'svelte/store'
import { publicApi } from '../lib/api'

type Thread = OriginalThread & { isFolded?: boolean }
export type CommentsStore = Thread[]

function getPersistedSort(): Sort {
	return localStorage.getItem('sort') || '-active'
}
